...
On phones, the New Session environment and workspace controls stack vertically. Long selected names wrap, and the operating-system and machine summary sits below the environment name. Desktop controls remain horizontal.
