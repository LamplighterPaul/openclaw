...
RPC and HTTP history reads prepare their physical target asynchronously and read
cold-archive metadata through that same retained history worker. Initial metadata
